...
[The TerminalHardwareSKU object](/api/terminal/hardware_skus/object)
...
- currencyenumThree-letter ISO currency code, in lowercase. Must be a supported currency.Possible enum valuesaedafnallamdangaoaarsaudawgaznShow 140 more
...
# Retrieve an available Terminal Hardware SKUPreview feature

[Retrieve an available Terminal Hardware SKU](/api/terminal/hardware_skus/retrieve)
...
# List all Terminal Hardware SKUsPreview feature

[List all Terminal Hardware SKUs](/api/terminal/hardware_skus/list)
...
[List Country Specs](/api#list_country_specs)
