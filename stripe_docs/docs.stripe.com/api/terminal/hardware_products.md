...
[The TerminalHardwareProduct object](/api/terminal/hardware_products/object)
...
- statusenumThe status of the terminal hardware product.Possible enum valuesavailableAvailable for new orders.unavailableCan no longer be used for order creation.
...
# Retrieve a Terminal Hardware ProductPreview feature

[Retrieve a Terminal Hardware Product](/api/terminal/hardware_products/retrieve)
...
# List all Terminal Hardware ProductsPreview feature

[List all Terminal Hardware Products](/api/terminal/hardware_products/list)

List all TerminalHardwareProduct objects.

- statusenumOnly return products that have the given status. Defaults to available.Possible enum valuesavailableAvailable for new orders.unavailableCan no longer be used for order creation.
