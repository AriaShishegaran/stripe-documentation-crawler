...
[The Customer Portal Session object](/api/customer_portal/sessions/object)
...
- flownullable objectInformation about a specific flow for the customer to go through. See the docs to learn more about using customer portal deep links and flows.Show child attributes
...
[docs](/customer-management/portal-deep-links)
...
[docs](/connect/separate-charges-and-transfers#settlement-merchant)

[Accounts API](/api/accounts/object#account_object-settings-branding)
...
[Create a portal session](/api/customer_portal/sessions/create)
...
[configuration](/api/customer_portal/configuration)

- flow_dataobjectInformation about a specific flow for the customer to go through. See the docs to learn more about using customer portal deep links and flows.Show child parameters
