...
[transactions](/reporting/balance-transaction-types)
...
- availablearray of objectsAvailable funds that you can transfer or pay out automatically by Stripe or explicitly through the Transfers API or Payouts API. You can find the available balance for each currency and payment type in the source_types property.Show child attributes
...
- pendingarray of objectsFunds that aren’t available in the balance yet. You can find the pending balance for each currency and each payment type in the source_types property.Show child attributes
...
[Accounting for negative balances](/connect/account-balances#accounting-for-negative-balances)
