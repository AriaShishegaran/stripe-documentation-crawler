...
[The Usage Record object](/api/usage_records/object)
...
[Create a usage record](/api/usage_records/create)
...
[parameter](/api/plans/create#create_plan-aggregate_usage)
...
[per-unit pricing](/api/plans/object#plan_object-billing_scheme)
...
[List all subscription item period summaries](/api/usage_records/subscription_item_summary_list)
