...
[The Early Fraud Warning object](/api/radar/early_fraud_warnings/object)
...
- payment_intentnullable stringExpandableID of the Payment Intent this early fraud warning is for, optionally expanded.

ID of the Payment Intent this early fraud warning is for, optionally expanded.

# Retrieve an early fraud warning

[Retrieve an early fraud warning](/api/radar/early_fraud_warnings/retrieve)

Retrieves the details of an early fraud warning that has previously been created.

Please refer to the early fraud warning object reference for more details.

[early fraud warning](#early_fraud_warning_object)
...
[List all early fraud warnings](/api/radar/early_fraud_warnings/list)
