...
[The Report Type object](/api/reporting/report_type/object)

- idstringThe ID of the Report Type, such as balance.summary.1.

The ID of the Report Type, such as balance.summary.1.

[ID of the Report Type](/reporting/statements/api#available-report-types)
...
[Retrieve a Report Type](/api/reporting/report_type/retrieve)
...
[List all Report Types](/api/reporting/report_type/list)
