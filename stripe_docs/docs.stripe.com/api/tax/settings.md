...
[The Tax Setting object](/api/tax/settings/object)
...
- head_officenullable objectThe place where your business is located.Show child attributes
...
[Update settings](/api/tax/settings/update)
...
[Retrieve settings](/api/tax/settings/retrieve)
