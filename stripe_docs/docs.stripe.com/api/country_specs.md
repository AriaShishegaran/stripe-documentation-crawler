...
- supported_bank_account_currenciesobjectCurrencies that can be accepted in the specific country (for transfers).Show child attributes
...
[ACH](https://stripe.com/docs/ach)

[charging through your platform](https://stripe.com/docs/connect/destination-charges)
...
[country_spec](#country_spec_object)

[an error](#errors)

# List Country Specs

[List Country Specs](/api/country_specs/list)
