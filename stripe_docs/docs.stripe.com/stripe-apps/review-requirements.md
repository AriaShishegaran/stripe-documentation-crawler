...
- Evolve your app in a way that version upgrades can be automatic, with no user intervention.
...
[Stripe Developer Terms of Service](http://stripe.com/legal/app-developer-agreement)
